...
static struct sst_acpi_mach sst_acpi_bytcr[] = {
	...
	{"10EC5651", "bytcr_rt5651", "/*(DEBLOBBED)*/", "bytcr_rt5651", NULL,
						&byt_rvp_platform_data },
	{"DLGS7212", "bytcht_da7213", "/*(DEBLOBBED)*/", "bytcht_da7213", NULL,
						&byt_rvp_platform_data },
	{"DLGS7213", "bytcht_da7213", "/*(DEBLOBBED)*/", "bytcht_da7213", NULL,
						&byt_rvp_platform_data },
	/* some Baytrail platforms rely on RT5645, use CHT machine driver */
	{"10EC5645", "cht-bsw-rt5645", "/*(DEBLOBBED)*/", "cht-bsw", NULL,
						&byt_rvp_platform_data },
	{"10EC5648", "cht-bsw-rt5645", "/*(DEBLOBBED)*/", "cht-bsw", NULL,
						&byt_rvp_platform_data },
	 ...
	 */
	{"80860F28", "bytcht_nocodec", "/*(DEBLOBBED)*/", "bytcht_nocodec", NULL,
						&byt_rvp_platform_data },
#endif
	{},
};
...
static struct sst_acpi_mach sst_acpi_chv[] = {
	{"10EC5670", "cht-bsw-rt5672", "/*(DEBLOBBED)*/", "cht-bsw", NULL,
						&chv_platform_data },
	{"10EC5672", "cht-bsw-rt5672", "/*(DEBLOBBED)*/", "cht-bsw", NULL,
						&chv_platform_data },
	{"10EC5645", "cht-bsw-rt5645", "/*(DEBLOBBED)*/", "cht-bsw", NULL,
						&chv_platform_data },
	{"10EC5650", "cht-bsw-rt5645", "/*(DEBLOBBED)*/", "cht-bsw", NULL,
						&chv_platform_data },
	{"10EC3270", "cht-bsw-rt5645", "/*(DEBLOBBED)*/", "cht-bsw", NULL,
						&chv_platform_data },
	...
	{"10EC5640", "bytcr_rt5640", "/*(DEBLOBBED)*/", "bytcr_rt5640", cht_quirk,
						&chv_platform_data },
	{"10EC3276", "bytcr_rt5640", "/*(DEBLOBBED)*/", "bytcr_rt5640", NULL,
						&chv_platform_data },
	 ...
	 * enabled explicitly and there is no codec-related information in SSDT
	 */
	{"808622A8", "bytcht_nocodec", "/*(DEBLOBBED)*/", "bytcht_nocodec", NULL,
						&chv_platform_data },
#endif
	{},
};
