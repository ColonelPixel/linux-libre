...
static ushort AscInitAsc1000Driver(ASC_DVC_VAR *asc_dvc)
{
	...
	if (asc_dvc->err_code != 0)
		return UW_ERR;
	if (AscLoadMicroCode(iop_base, 0, NULL,
			     (unsigned short)0) != (ADV_DCNT)0) {
...
static int AdvInitAsc3550Driver(ADV_DVC_VAR *asc_dvc)
{
	...
	asc_dvc->err_code = AdvLoadMicrocode(iop_base, NULL,
					(unsigned short)0, ADV_3550_MEMSIZE,
					(ADV_DCNT)0);
	if (asc_dvc->err_code)
		return ADV_ERROR;
...
static int AdvInitAsc38C0800Driver(ADV_DVC_VAR *asc_dvc)
{
	...
	asc_dvc->err_code = AdvLoadMicrocode(iop_base, NULL,
				 (unsigned short)0, ADV_38C0800_MEMSIZE,
				 (ADV_DCNT)0);
	if (asc_dvc->err_code)
		return ADV_ERROR;
...
static int AdvInitAsc38C1600Driver(ADV_DVC_VAR *asc_dvc)
{
	...
	asc_dvc->err_code = AdvLoadMicrocode(iop_base, NULL,
				 (unsigned short)0, ADV_38C1600_MEMSIZE,
				 (ADV_DCNT)0);
	if (asc_dvc->err_code)
		return ADV_ERROR;
