...
#define FIRMWARE_2870_FILENAME		"/*(DEBLOBBED)*/"
/*(DEBLOBBED)*/

#define FIRMWARE_3070_MIN_VERSION	17
#define FIRMWARE_3070_FILENAME		"/*(DEBLOBBED)*/"
/*(DEBLOBBED)*/

#define FIRMWARE_3071_MIN_VERSION	17
#define FIRMWARE_3071_FILENAME		"/*(DEBLOBBED)*/"	/* for RT3071/RT3072 */
/*(DEBLOBBED)*/
...
#define FIRMWARE_2860_FILENAME		"/*(DEBLOBBED)*/"
/*(DEBLOBBED)*/

#define FIRMWARE_3090_MIN_VERSION	19
#define FIRMWARE_3090_FILENAME		"/*(DEBLOBBED)*/"	/* for RT3090/RT3390 */
/*(DEBLOBBED)*/
...
static const struct firmware *rtmp_get_firmware(struct rt_rtmp_adapter *adapter)
{
	...
	err = reject_firmware(&fw, name, dev);
	if (err) {
