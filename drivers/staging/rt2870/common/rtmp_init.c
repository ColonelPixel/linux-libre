...
#define NICLF_DEFAULT_USE()	\
	...
	// New 8k byte firmware size for RT3071/RT3072
	//printk("Usb Chip\n");
	if (/*(DEBLOBBED)*/ FIRMWAREIMAGE_MAX_LENGTH)
	...
	IN PRTMP_ADAPTER pAd)
{
	...
	{
		NdisInitializeString(&FileName,"/*(DEBLOBBED)*/");
		DBGPRINT(RT_DEBUG_TRACE, ("NICLoadRateSwitchingParams: load file - /*(DEBLOBBED)*/ for tx rate switch \n"));
	}
	else
	{
