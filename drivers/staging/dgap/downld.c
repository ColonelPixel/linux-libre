...
struct image_info {
	...
	char	*name;
	char	*fname;		/* filename of binary /*(DEBLOBBED)*/
	char	*pathname;	/* pathname to this binary /*(DEBLOBBED)*/
...
#define DEFAULT_LOC /*(DEBLOBBED)*/

struct image_info	*image_list;
int			nimages, count;

struct image_info images[] = {
{IBIOS, T_EPC,      SUBTYPE, 0, NULL, "EPC/X",	"/*(DEBLOBBED)*/", DEFAULT_LOC "/*(DEBLOBBED)*/", 0 },
{IFEP,  T_EPC,      SUBTYPE, 0, NULL, "EPC/X",	"/*(DEBLOBBED)*/", DEFAULT_LOC "/*(DEBLOBBED)*/", 0 },
{ICONC, T_EPC,      SUBTYPE, 0, NULL, "EPC/X",	"/*(DEBLOBBED)*/", DEFAULT_LOC "/*(DEBLOBBED)*/", 0 },

{IBIOS, T_CX,       SUBTYPE, 0, NULL, "C/X",	"/*(DEBLOBBED)*/", DEFAULT_LOC "/*(DEBLOBBED)*/", 0 },
{IFEP,  T_CX,       SUBTYPE, 0, NULL, "C/X",	"/*(DEBLOBBED)*/", DEFAULT_LOC "/*(DEBLOBBED)*/", 0 },

{IBIOS, T_CX,       T_PCIBUS, 0, NULL, "C/X PCI", "/*(DEBLOBBED)*/", DEFAULT_LOC "/*(DEBLOBBED)*/", 0 },
{IFEP,  T_CX,       T_PCIBUS, 0, NULL, "C/X PCI", "/*(DEBLOBBED)*/", DEFAULT_LOC "/*(DEBLOBBED)*/", 0 },

{ICONC, T_CX,       SUBTYPE, 0, NULL, "C/X",	"/*(DEBLOBBED)*/", DEFAULT_LOC "/*(DEBLOBBED)*/", 0 },
{ICONC, T_CX,       SUBTYPE, 0, NULL, "C/X",	"/*(DEBLOBBED)*/", DEFAULT_LOC "/*(DEBLOBBED)*/", 0 },
{ICONC, T_CX,       SUBTYPE, 0, NULL, "C/X",	"/*(DEBLOBBED)*/", DEFAULT_LOC "/*(DEBLOBBED)*/", 0 },

{IBIOS, FAMILY,   T_PCXR, 0, NULL, "PCXR",	"/*(DEBLOBBED)*/", DEFAULT_LOC "/*(DEBLOBBED)*/", 0 },
{IFEP,  FAMILY,   T_PCXR, 0,  NULL,  "PCXR",	"/*(DEBLOBBED)*/", DEFAULT_LOC "/*(DEBLOBBED)*/", 0  },

{IBIOS, T_PCLITE,   SUBTYPE, 0, NULL, "X/em",	"/*(DEBLOBBED)*/", DEFAULT_LOC "/*(DEBLOBBED)*/", 0 },
{IFEP,  T_PCLITE,   SUBTYPE, 0,  NULL,  "X/em",	"/*(DEBLOBBED)*/", DEFAULT_LOC "/*(DEBLOBBED)*/", 0  },

{IBIOS, T_EPC,      T_PCIBUS, 0, NULL, "PCI",	"/*(DEBLOBBED)*/", DEFAULT_LOC "/*(DEBLOBBED)*/", 0 },
{IFEP,  T_EPC,      T_PCIBUS, 0, NULL, "PCI",	"/*(DEBLOBBED)*/", DEFAULT_LOC "/*(DEBLOBBED)*/", 0 },
