...
#define _IWL6000_MODULE_FIRMWARE(api) IWL6000_FW_PRE /*(DEBLOBBED)*/
#define IWL6000_MODULE_FIRMWARE(api) _IWL6000_MODULE_FIRMWARE(api)

#define IWL6050_FW_PRE "/*(DEBLOBBED)*/"
#define _IWL6050_MODULE_FIRMWARE(api) IWL6050_FW_PRE /*(DEBLOBBED)*/
#define IWL6050_MODULE_FIRMWARE(api) _IWL6050_MODULE_FIRMWARE(api)

#define IWL6000G2A_FW_PRE "/*(DEBLOBBED)*/"
#define _IWL6000G2A_MODULE_FIRMWARE(api) IWL6000G2A_FW_PRE /*(DEBLOBBED)*/
#define IWL6000G2A_MODULE_FIRMWARE(api) _IWL6000G2A_MODULE_FIRMWARE(api)

#define IWL6000G2B_FW_PRE "/*(DEBLOBBED)*/"
#define _IWL6000G2B_MODULE_FIRMWARE(api) IWL6000G2B_FW_PRE /*(DEBLOBBED)*/
#define IWL6000G2B_MODULE_FIRMWARE(api) _IWL6000G2B_MODULE_FIRMWARE(api)

#define IWL130_FW_PRE "/*(DEBLOBBED)*/"
#define _IWL130_MODULE_FIRMWARE(api) IWL130_FW_PRE /*(DEBLOBBED)*/
