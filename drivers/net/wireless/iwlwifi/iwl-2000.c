...
#define _IWL2030_MODULE_FIRMWARE(api) IWL2030_FW_PRE /*(DEBLOBBED)*/
#define IWL2030_MODULE_FIRMWARE(api) _IWL2030_MODULE_FIRMWARE(api)

#define IWL2000_FW_PRE "/*(DEBLOBBED)*/"
#define _IWL2000_MODULE_FIRMWARE(api) IWL2000_FW_PRE /*(DEBLOBBED)*/
#define IWL2000_MODULE_FIRMWARE(api) _IWL2000_MODULE_FIRMWARE(api)

#define IWL200_FW_PRE "/*(DEBLOBBED)*/"
#define _IWL200_MODULE_FIRMWARE(api) IWL200_FW_PRE /*(DEBLOBBED)*/
