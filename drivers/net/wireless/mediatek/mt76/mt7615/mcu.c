...
static int mt7615_load_patch(struct mt7615_dev *dev)
{
	...
	ret = reject_firmware(&fw, MT7615_ROM_PATCH, dev->mt76.dev);
	if (ret)
		goto out;
...
static int mt7615_load_ram(struct mt7615_dev *dev)
{
	...
	ret = reject_firmware(&fw, MT7615_FIRMWARE_N9, dev->mt76.dev);
	if (ret)
		return ret;
	...
	ret = reject_firmware(&fw, MT7615_FIRMWARE_CR4, dev->mt76.dev);
	if (ret)
		return ret;
